...
*** 完 Thesis Outline 
**** Introduction: What to Make of Metaphors in Economics?
This section will introduce the topic of metaphors in economics. 
****  The Genealogy of the Brain Computer Metaphor in Simon's Work.
**** The Influence of the Brain-Computer Metaphor in Simon's Concept of Rationality.
**** Conclusion
...
# \printbibliography[keyword={brain,social science, computer, cold war}, title={Littérature épique : généralités}, prenote=introduction, postnote=postscriptum]

# \printbibliography[keyword=Brain, keyword=Computers]
# \lipsum
...
# #+LATEX_HEADER: \DeclareFieldFormat{title}{\color{Grey}\mkbibemph{#1}}
