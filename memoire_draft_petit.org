...
apotheosis of technological revolution---and /not/ political revolution---,
...
The reason for writing a thesis on Henry Simon is /not/ to write another
...
Particularly, I am interested in Simon because he was more /cyborg/ than
...
#+LATEX_HEADER: \usepackage[backend=biber,style=authoryear,arxiv=false,doi=false,isbn=false,url=false]{biblatex}
# #+LATEX_HEADER: \usepackage[backend=biber,style=authoryear,doi=false,isbn=false,url=true]{biblatex}
# Color the title in the bibliography
# #+LATEX_HEADER: \DeclareFieldFormat{title}{\color{darkblue}\mkbibemph{#1}}
...
# #+LATEX_HEADER: \DeclareFieldFormat{title}{\color{darkblue}\mkbibemph{#1}}
# Color those entries in the bibliography that are books 
# #+LATEX_HEADER:\AtEveryBibitem{\ifentrytype{book}{\color{blue}}{}}
...
*** Bibliography
# Change font size for bibliography
