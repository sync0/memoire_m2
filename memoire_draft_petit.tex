...
\documentclass[paper=A5,portrait,twoside=true,twocolumn=false,headinclude=false,footinclude=false,fontsize=11,BCOR=15mm,DIV=calc,pagesize=auto,titlepage=firstiscover,mpinclude=false,headings=normal,headings=twolinechapter,open=right,chapterprefix=false,headsepline=true]{scrbook}
\usepackage{fontspec}
\usepackage{xunicode}
\usepackage{url}
\usepackage{soul}
...
\label{sec:org6381d62}
\chapter{Marx et Ricardo}
\label{sec:org35205e5}
\lipsum
\section{Marx et Ricardo et Smith}
\label{sec:orge2738a7}
\lipsum
\part{La vérité juridique}
\label{sec:orgd9d118f}
\chapter{Marx et Ricardo}
\label{sec:org4484aef}
\lipsum
\section{Marx et Ricardo et Smith}
\label{sec:orgd33e55a}
\lipsum
\end{document}