...
\documentclass[paper=A5,portrait,twoside=true,twocolumn=false,headinclude=true,footinclude=true,fontsize=11,BCOR=15mm,DIV=calc,pagesize=auto,titlepage=firstiscover,mpinclude=false,headings=normal,headings=twolinechapter,open=right,chapterprefix=false]{scrbook}
\usepackage{fontspec}
\usepackage{xunicode}
\usepackage{url}
\usepackage{soul}
...
\label{sec:org3a47a25}
\chapter{Marx et Ricardo}
\label{sec:org3507315}
\lipsum
\part{La vérité juridique}
\label{sec:orge17d5d8}
\chapter{Marx et Ricardo}
\label{sec:orge067786}
\lipsum
\end{document}